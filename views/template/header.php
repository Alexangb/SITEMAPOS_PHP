	...
	<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					<a href="widgets.html">
						<div class="parent-icon"><i class="fa-duotone fa-house-person-return"></i>
						</div>
				...
				<li>
					<a href="widgets.html">
						<div class="parent-icon"><i class="fa-brands fa-cc-visa"></i>
						</div>
				...
				<li>
					<a href="widgets.html">
						<div class="parent-icon"><i class="fa-solid fa-code-compare"></i>
						</div>
				...
				<li>
					<a href="widgets.html">
						<div class="parent-icon"><i class="fa-solid fa-check-to-slot"></i>
						</div>
